...
#control_1_name = 'sknJnt_r_upperArm1'
control_1_name = 'sknJnt_r_foreArm1'

#control_2_name = 'sknJnt_r_foreArm1'
control_2_name = 'sknJnt_r_foreArm3'


space_swtch_attr = attr_obj + '.Space_Switch'
#attr_obj + '.Space_Switch', 0  #Global_Ctrl
#attr_obj + '.Space_Switch', 1  #Waist_Ctrl
...
mc.setAttr( prnt_cnst_attrB,  1 ) #waist ctrl to off
mc.setAttr( scl_cnst_attrA,  1 ) #global ctrl to on
mc.setAttr( scl_cnst_attrB,  1 ) #waist ctrl to off
